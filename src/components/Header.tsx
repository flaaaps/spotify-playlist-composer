...
const Header: React.FC<Props> = () => {
    ...
    const buttonText =
        state === "done" && profile?.display_name ? profile.display_name : state === "computing" ? "Loading..." : "Login with Spotify"
        ...
        <div className="w-full bg-emerald-500 shadow-md z-50">
            <div className="w-full flex justify-between items-center py-3 px-7 max-w-screen-lg mx-auto">
                <div className="whitespace-nowrap flex-nowrap">
                    <p className="text-xl font-bold tracking-tight text-white m-0 p-0">Spotify Playlist Composer</p>
                    <p className="text-sm font-normal tracking-tight text-white opacity-75 -mt-1">by Inception Cloud</p>
                </div>
